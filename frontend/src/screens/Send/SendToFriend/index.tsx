...
function SendToFriend(props: any) {
            ...
            <View style={styles._exchange_btn_main}>
              {price === "" ? (
                <TouchableOpacity style={styles._exchange_btn_empty}>
                  <Text style={styles._exchange_btn_empty_text}>Choose recipient</Text>
                </TouchableOpacity>
              ) : (
                <BgColorButton
                  bgColor="#347AF0"
                  btnTextColor="#fff"
                  btnTitle="Choose recipient"
                  path={()=> props.navigation.navigate("ChooseRecipient")}
                />
              )}
            </View>
        </View>
