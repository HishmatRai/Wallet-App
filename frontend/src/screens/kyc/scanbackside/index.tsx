...
function ScanBackSide(props: any) {
  return (
      ...
      >
        <View style={styles._data_main}>
          <View style={styles._header_main}>
            ...
            <Text style={styles._heading}>Scan Back Side</Text>
          ...
          <BgColorButton
            ...
            btnTextColor="#fff"
            btnTitle="Scan Now"
            path={() => props.navigation.navigate("NationalIDScan")}
          />
        </View>
      </ImageBackground>
    </View>
